    ...
    <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
      <div className="mb-6">
        <div className="flex items-center gap-2">
          ...
          <HelpTooltip content="Percentual de empresas que avancaram entre os estagios do programa. Verde: excelente (≥70%), Amarelo: regular (40-69%), Vermelho: baixo (<40%)" />
        </div>
          ...
          <div key={index} className="p-4 bg-gray-50 rounded-lg border border-gray-200">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-2">
                ...
                <HelpTooltip content={`Percentual de empresas que completaram a transicao ${transition.label}`} />
              </div>
              <Tooltip content={`Taxa: ${transition.rate.toFixed(1)}%`}>
                <div className={`w-8 h-8 ${getTrendBg(transition.rate)} rounded-lg flex items-center justify-center cursor-help`}>
